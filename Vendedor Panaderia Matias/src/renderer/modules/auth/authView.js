      ...
      <div class="w-full max-w-sm overflow-hidden panel shadow-2xl">
        <section class="bg-papel p-8 lg:p-10">
          <div class="mb-10 text-center">
            <img src="./assets/logo.png" alt="Logo Panadería Matías" class="w-32 mx-auto mb-6">
            <h1 class="text-3xl font-bold text-cafe">Panadería Matías</h1>
            <p class="mt-2 text-sm text-[#6a584b]">Terminal de ventas</p>
          </div>
...
export function attachLoginEvents({ onLoggedIn = () => {} } = {}) {
  ...
  form?.addEventListener('submit', async (event) => {
    ...
    // La URL base viene desde config.js o desde la sesión guardada.
    ...
    try {
      ...
      if (submitButton) {
        ...
        submitButton.textContent = 'Entrar a Ventas';
      }
    }
  });
}
